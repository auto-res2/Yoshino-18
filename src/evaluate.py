...
_RESEARCH_DIR = Path(".research") / "iteration1"
...
def run_experiment_1(cfg: dict):
    ...
    # Embedding model ---------------------------------------------------------
    base_name = cfg["exp1"]["embed_model"]
...
def run_experiment_2(cfg: dict):
    ...
    for _ in tqdm(range(num_docs)):
        ...
        verify_times.append(0.001)  # placeholder constant
...
def run_experiment_3(cfg: dict):
    ...
    for lang in tqdm(languages):
        energy_per_lang[lang] = random.uniform(0.8, 1.2) * 100
